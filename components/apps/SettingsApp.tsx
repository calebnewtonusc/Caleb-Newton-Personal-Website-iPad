  ...
  sports: {
    ...
    render: () => (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        {/* Left curved seam */}
        <path
          d="M6.5 2C4.2 4.5 4.2 13.5 6.5 16"
          stroke="white"
          strokeWidth="1.2"
          strokeLinecap="round"
          fill="none"
        ...
        {/* Right curved seam */}
        <path
          d="M11.5 2C13.8 4.5 13.8 13.5 11.5 16"
          stroke="white"
          strokeWidth="1.2"
          strokeLinecap="round"
          fill="none"
  ...
  film: {
    ...
    render: () => (
      <svg width="18" height="14" viewBox="0 0 18 14" fill="none">
        ...
        <path
          d="M4.5 1v3.5M9 1v3.5M13.5 1v3.5"
          stroke="white"
          strokeWidth="1"
          strokeLinecap="round"
        />
        <path
          d="M4.5 9.5V13M9 9.5V13M13.5 9.5V13"
          stroke="white"
          strokeWidth="1"
          strokeLinecap="round"
        />
  ...
  system: {
    ...
    render: () => (
      <svg width="17" height="17" viewBox="0 0 17 17" fill="none">
        ...
        />
        <path
          d="M3.2 3.2l1.55 1.55M12.25 12.25l1.55 1.55M3.2 13.8l1.55-1.55M12.25 4.75l1.55-1.55"
          stroke="white"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
          ...
          {(isLandscape || !selectedSection) && (
            ...
            >
              <div
                ...
                style={{ overflowY: "auto", padding: "20px 16px 32px" }}
              >
                {/* Large title */}
                <h1
                  style={{
                ...
                {SECTION_GROUPS.map((group, gi) => {
                  const groupSections = group
                    .map((id) => personalSettings.find((s) => s.icon === id))
                    .filter(Boolean) as typeof personalSettings;
        ...
        <AnimatePresence mode="wait">
          {selectedSection === PROFILE_SECTION && (
            ...
            >
              <div
                className="ios-scroll"
                style={{ overflowY: "auto", padding: "16px 16px 32px" }}
              >
                {!isLandscape && (
                  <button
