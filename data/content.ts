...
export const profile = {
  ...
  greeting: "I'm a follower of Jesus and a USC sophomore at the Iovine and Young Academy.",
  headline:
    "For most of my life \u201cyou think too much, kid\u201d was a criticism. It turned out to be the point.",
  shaped: [
    {
      title: "The diagnosis",
      period: "Senior year of high school",
      body: "I was diagnosed autistic at the start of my senior year, and it reframed the whole thing. The systematic thinking was never the problem. It was the point.",
    },
    {
      title: "The arm",
      period: "The year after",
      body: "I threw 84 as a closer until my arm gave out and I dropped to 70. I spent a year reading sports science papers and rebuilding my mechanics, and I got back to 81. Not all the way. But that was the first time research stopped being homework and turned into something I could use on myself.",
    },
    {
      title: "The junkyard",
      period: "Dominican Republic, 2022",
      body: "I played baseball in a junkyard in the Dominican Republic. The people there had close to nothing and were the most joyful I had ever met. It rearranged what I thought joy came from.",
    },
  ],
  shapedClose:
  ...
  now: [
    ...
    { label: "Studying", value: "Innovation at USC, class of 2029" },
    { label: "Reading", value: "Non-fiction, theology, neuroscience" },
  ],
  roles: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Small Talk", type: "toggle-off", detail: "Ask me something real" },
      {
        ...
        type: "toggle-on",
        detail: "Something merged every week",
      },
      {
