  ...
  aboutGroups: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Community based ventures", type: "toggle-on", detail: "" },
...
export const health = {
  ...
  intro:
    "I spent freshman year losing almost everything I had used to define myself by. This is what happened, and what I still have.",
  chapters: [
    {
      id: "pillars",
      title: "I showed up with nothing",
      color: "#8E8E93",
      quote: "I arrived at USC with none of the three things I had used to know who I was.",
      body: "For most of my life I had three things. Baseball, where I closed games at 84 until my arm gave out. STEM, which started with memorizing 200 digits of pi at ten and ended up as control theory research at Caltech. And leading, a Christian club of 90 and a coalition of twenty schools built out of cold calls.\n\nI got to USC holding none of them. The arm was done, the research was over, and nobody at a new school cares what you ran in high school. I did not understand at the time that losing all three at once does something to a person.",
    },
    {
      id: "built",
      title: "I built something first",
      color: "#007AFF",
      quote: "It failed, and I drew the wrong conclusion from it.",
      body: "The summer before freshman year, friends from my academy and I built WEB, a relationship network meant to be an alternative to Instagram. We actually shipped it. It did not work, and I decided software could never beat big tech at its own game.\n\nThen every entrepreneurship club at USC rejected me and I decided that was the end of the road. I was eighteen and both of those conclusions were wrong.",
    },
    {
      id: "focus",
      title: "I thought it was a focus problem",
      color: "#FF9500",
      quote: "It was not a person failing at college. It was an illness nobody had named yet.",
      body: "By the fall I could not work and I assumed I had broken something in my attention, so that is what I said out loud and that is what got treated. What I actually had was depression that nobody had diagnosed, and treating the wrong thing made it worse quickly. It ended with me in a hospital.\n\nI want to be plain about that, because the version where I simply could not handle freedom is the version people expect, and it is wrong. I was sick, it was misread, and it got dangerous fast.",
    },
    {
      id: "alone",
      title: "Nobody knew where I was",
      color: "#636366",
      quote: "The isolation did more damage than the workload ever did.",
      body: "I had also spent the fall church-hopping through every church USC students go to and landed at one with no college students in it. No brothers, no mentors, nobody who would notice if I went quiet for a week.\n\nI had built my whole life out of teams, and I went into the hardest months of it without one.",
    },
    {
      id: "anyway",
      title: "I won anyway",
      color: "#34C759",
      quote: "I was not fixed. I was doing it anyway.",
      body: "That spring I went back to a ministry where people actually knew me, and brothers from a Christian fraternity carried me through the worst of the depression. I joined the biotech team at the Marshall AI Association and we won demo day. Through that team I met the people I now work with every week.\n\nNone of that happened after I got better. It happened while I was still sick.",
    },
    {
      id: "mania",
      title: "Then it went the other direction",
      color: "#FF3B30",
      quote: "Mania is not a mood. It is certainty.",
      body: "Later that spring it flipped. Everything felt right. I said things with total confidence and did things with total confidence that I would never have said or done otherwise, and none of it felt like a symptom from the inside. That is the part that is hard to explain to people who have not seen it.\n\nIt lasted about two months and ended with a required medical leave from USC.",
    },
    {
      id: "arizona",
      title: "Arizona",
      color: "#5856D6",
      quote: "A mentor made room for me when I had nowhere else to be.",
      body: "I spent part of that leave in Arizona with a mentor who took me in. My family was away on a trip I did not have a ticket for.\n\nIt is a strange thing to be grateful for and I am grateful for it. I learned more in those weeks about what I actually want my life to be for than in the whole year that preceded them.",
    },
    {
      id: "fortythree",
      title: "Forty-three",
      color: "#FF9500",
      quote: "I used to think that number was evidence something was wrong with me.",
      body: "A friend and I counted how many times I changed direction that year. Forty-three. Majors, plans, identities, whole versions of the future.\n\nThen I went back through everything I had made since I was seventeen. My college essay argued that you do not beat a bad thing by fighting it, you make the good thing more desirable. The network we built the next summer was that. The project after it, where a friend and I wrote down in plain words that the enemy was moral apathy, was that. What I am building now is that.\n\nSame enemy, three times, five years, and I never noticed I was doing it. I have changed my major more times than most people change their mind about lunch. I have never once switched off the actual thing.",
    },
    {
      id: "here",
      title: "Still here",
      color: "#FF2D55",
      quote: "The middle is not the whole story.",
      body: "I came back. I am a sophomore, I am well, and I am building again with a much clearer idea of what I am building against.\n\nIf you are somewhere in the middle of your own version of this and it does not have an ending yet, that is the only thing I have worth telling you. I did not get through it by being strong. I got through it because God did not leave, and neither did the people He put around me.",
    },
  ],
  categories: [
    {
