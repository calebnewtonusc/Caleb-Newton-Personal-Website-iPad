...
export const experience = [
  ...
  },
  {
    ...
    color: "#16A34A",
    website: "",
    description: "Food Marketplace Startup.",
    achievements: [
      "Identified a structural gap in California's home-cook economy & built Silo to aggregate consumer demand; secured an official Cooks Alliance partnership unlocking 1,000+ permitted cooks for statewide expansion.",
      "Building Silo's statewide California GTM launch with USC Annenberg & the School of Cinematic Arts as its creative engine, with support from Praxis.co ($897M+ portfolio), developing a content-led acquisition strategy to drive demand at scale.",
      "Won the USC New Venture Pitch Competition & validated marketplace economics against Uber & DoorDash benchmarks.",
    ],
    skills: [
      "Marketplace",
      "GTM",
